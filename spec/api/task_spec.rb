...
RSpec.describe 'Tasks endpoints', type: :request do
  ...
  let(:deadline_params) { request_params(deadline: Date.parse('2020-09-29')) }
  ...
  context 'PATCH /api/v1/projects/:project_id/tasks/:id' do
  ...
  context 'DELETE /api/v1/projects/:project_id/tasks/:id' do
    context 'user is logged in' do
  ...
  context 'PATCH /api/v1/projects/:project_id/tasks/:id/position' do
    context 'user is logged in' do
      ...
      it "change task's position" do
        ...
        expect { patch position_api_v1_project_task_path(project, task), headers: user_token, params: valid_position }
          .to(
  ...
  context 'PATCH /api/v1/projects/:project_id/tasks/:id/complete' do
    context 'user is logged in' do
      it 'return status #create' do
  ...
  context 'PATCH /api/v1/projects/:project_id/tasks/:id/deadline' do
    context 'user is logged in' do
      it 'return status #create' do
        patch deadline_api_v1_project_task_path(project, task), headers: user_token, params: deadline_params
        expect(response).to have_http_status(:created)
      end
    end
    ...
    context 'user is not logged in' do
      it 'returns status unauthorized' do
        patch deadline_api_v1_project_task_path(project, task), params: valid_position
        expect(response).to have_http_status(:unauthorized)
      end
    end
  end
